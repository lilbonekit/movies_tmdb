export const Close = ({clear = null, className = null}) => {
    return(
        <svg onClick={clear} className={className} xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
